...
class m140506_102106_rbac_init extends \yii\db\Migration
{
    ...
    public function up()
    {
        ...
        $this->createIndex('idx-assignment-item_name', $authManager->assignmentTable, 'item_name');
        $this->createIndex('idx-assignment-user_id', $authManager->assignmentTable, 'user_id');
